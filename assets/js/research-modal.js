...
(function () {
  ...
  const THEMES = [
    {
      id: 'uhi',
      title: 'Extreme Heat, Risk & Resilience',
      titleZh: '极端高温、风险与韧性',
      kicker: 'Theme 01',
      kickerZh: '主题 01',
      ...
      tagline:
        'From mapping urban heat to predicting the heatwaves that put whole communities at risk.',
      taglineZh:
        '从描绘城市热岛，到预测把整片社区置于风险中的热浪。',
      body: [
        'Heat does not reach a city evenly. Working-class neighbourhoods, ageing high-rises and communities far from green space carry the worst of urban heat — and the health consequences that follow. My earlier work mapped this with Landsat thermal imagery, sociodemographic data and machine learning, surfacing the populations most exposed.',
        'This is now the focus of my doctoral research at Cardiff: multi-scale heatwave prediction that fuses satellite remote sensing with machine learning, then links the resulting hazard maps to community resilience — modelling how elderly, low-income and outdoor-working groups actually adapt, so that cooling and green infrastructure reach those most often left behind.',
      ],
      bodyZh: [
        '高温不会均匀地抵达一座城市。工薪阶层社区、老旧高层、远离绿地的街区，承受着城市高温最严重的部分——以及随之而来的健康代价。我此前的工作用 Landsat 热红外影像、社会人口数据与机器学习描绘了这一点，识别出最易暴露的人群。',
        '这如今是我在卡迪夫博士研究的重心：多尺度的热浪预测——把卫星遥感与机器学习相融合，再将由此得到的致灾地图与社区韧性连接起来：模拟老人、低收入者与户外工作者如何真实地适应高温，让降温与绿色基础设施真正触及最常被落下的人群。',
      ],
      image: './assets/fig/research/heat%20risk.png',
      visual: 'uhi',
    },
    {
      id: 'ml',
      ...
      image: './assets/fig/research/AI_ML.png',
      visual: 'ml',
    },
    {
      id: 'rs',
      ...
      image: './assets/fig/research/urban%20land%20use.png',
      visual: 'rs',
    },
    {
      id: 'justice',
      ...
      image: './assets/fig/research/env%20justice.png',
      visual: 'justice',
    },
  ];
  ...
  function renderVisual(theme) {
    if (theme.image) {
      return `<img class="research-box-img" src="${attr(theme.image)}" alt="" loading="lazy" decoding="async" `
